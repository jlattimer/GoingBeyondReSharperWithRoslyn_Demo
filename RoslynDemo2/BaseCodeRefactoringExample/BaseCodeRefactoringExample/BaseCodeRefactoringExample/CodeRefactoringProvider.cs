...
namespace BaseCodeRefactoringExample
{
	[ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(BaseCodeRefactoringExampleCodeRefactoringProvider)), Shared]
	internal class BaseCodeRefactoringExampleCodeRefactoringProvider : CodeRefactoringProvider
	{
