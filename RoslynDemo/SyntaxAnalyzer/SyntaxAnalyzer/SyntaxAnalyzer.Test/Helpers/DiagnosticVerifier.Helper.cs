...
namespace TestHelper
{
	...
	public abstract partial class DiagnosticVerifier
	{
		...
		//Add additional project references so they are included in the compilation - need to add reference in 'CreateProject' as well
		//private static readonly MetadataReference XrmReference = MetadataReference.CreateFromFile("F:\\2015 SDK\\SDK\\Bin\\Microsoft.Xrm.Sdk.dll");
		...
		private static Project CreateProject(string[] sources, string language = LanguageNames.CSharp)
		{
			...
			var solution = new AdhocWorkspace()
				...
				//.AddMetadataReference(projectId, XrmReference); //Add additional project references so they are included in the compilation
